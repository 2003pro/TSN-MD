...
def prepare_data(pairs_trained, pairs_tested, trim_min_count, generate_nums, copy_nums, tree=False):
    ...
    for pair in pairs_trained:
        ...
        train_pairs.append((input_cell, len(input_cell), output_cell, len(output_cell),
                            pair[2], pair[3], num_stack, pair[4], recod_idx))
        recod_idx += 1
...
def prepare_train_batch(pairs_to_batch, batch_size):
    ...
    for batch in batches:
        ...
        num_value_batch = []
        idx_batch = []
        for i, li, j, lj, num, num_pos, num_stack, group, idx in batch:
    ...
    return input_batches, input_lengths, output_batches, output_lengths, nums_batches, num_stack_batches, num_pos_batches, num_size_batches, num_value_batches, graph_batches, idx_batches
