...
def train_tree(input_batch, input_length, target_batch, target_length, nums_stack_batch, num_size_batch, generate_nums,
               ...
               merge_optimizer, output_lang, num_pos, batch_graph, idx_batch, sf_dic, predict_1, generate_1, merge_1, predict_1_optimizer, generate_1_optimizer, merge_1_optimizer, encoder_mask, alpha, english=False):
    ...
    #print(loss2.shape)
    #loss = loss_0 + loss_1
    loss = (1-alpha)*loss1 + alpha*loss2 + (1-alpha)*loss3 + alpha*loss4 + 0.1*cos_loss
    loss.backward()
    # clip the grad
