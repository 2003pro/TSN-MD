...
def train_tree(input_batch, input_length, target_batch, target_length, nums_stack_batch, num_size_batch, generate_nums,
               ...
               merge_optimizer, output_lang, num_pos, batch_graph, idx_batch, sf_dic, predict_1, generate_1, merge_1, predict_1_optimizer, generate_1_optimizer, merge_1_optimizer, english=False):
    ...
    for t in range(max_target_length):
        num_score, op, current_embeddings, current_context, current_nums_embeddings = predict_1(
            node_stacks_1, left_childs_1, encoder_outputs, all_nums_encoder_outputs_1, padding_hidden, seq_mask, num_mask)
...
def evaluate_tree(input_batch, input_length, generate_nums, encoder, predict, generate, merge, output_lang, num_pos, batch_graph, predict_1, generate_1, merge_1, beam_size=5, english=False, max_length=MAX_OUTPUT_LENGTH):
